...
# ==========================================
    ...
    with col_d2:
        ...
        if not st.session_state.db_dock.empty:
            ...
            st.info("Aucun mouvement enregistré ce jour.")
...
# ==========================================
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        st.caption("Import Excel bientôt disponible")
    ...
    if not df_reap.empty:
        ...
        st.success("✅ Aucun réapprovisionnement nécessaire.")
