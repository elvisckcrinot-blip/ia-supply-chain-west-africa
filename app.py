...
with st.sidebar:
    ...
    # Liens vers les fichiers présents sur votre GitHub
    st.page_link("app.py",                   label="🏠 Accueil Hub", icon="🏠")
    st.page_link("pages/1_TMS_Logistics.py", label="🚛 TMS Logistics", icon="🚚")
    st.page_link("pages/2_WMS_Logistics.py", label="📦 WMS Logistics", icon="📦")
